...
################################################################################
## Form generated from reading UI file 'desg_genctl.ui'
##
...
class Ui_ParusGenWindow(object):
    def setupUi(self, ParusGenWindow):
        ...
        self.setTypBox = QComboBox(self.outBox)
        self.setTypBox.addItem("")
        self.setTypBox.addItem("")
        self.setTypBox.addItem("")
        self.setTypBox.addItem("")
        self.setTypBox.setObjectName(u"setTypBox")
        self.setTypBox.setMinimumSize(QSize(90, 22))
        self.setTypBox.setMaximumSize(QSize(100, 22))
        self.setTypBox.setFont(font2)

        self.outBoxLayout.addWidget(self.setTypBox)

        self.outPath = QLineEdit(self.outBox)
        self.outPath.setObjectName(u"outPath")
        self.outPath.setMinimumSize(QSize(900, 22))
    ...
    def retranslateUi(self, ParusGenWindow):
        ...
        self.outBox.setToolTip(QCoreApplication.translate("ParusGenWindow", u"Generated dataset type", None))
#endif // QT_CONFIG(tooltip)
        self.outBox.setTitle(QCoreApplication.translate("ParusGenWindow", u"Generated Signal Output Directory", None))
        self.setTypBox.setItemText(0, QCoreApplication.translate("ParusGenWindow", u"General", None))
        self.setTypBox.setItemText(1, QCoreApplication.translate("ParusGenWindow", u"Training", None))
        self.setTypBox.setItemText(2, QCoreApplication.translate("ParusGenWindow", u"Validation", None))
        self.setTypBox.setItemText(3, QCoreApplication.translate("ParusGenWindow", u"Testing", None))

        self.outPath.setPlaceholderText(QCoreApplication.translate("ParusGenWindow", u"Select folder for storing generated signals, define dataset type with the combobox left", None))
