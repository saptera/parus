...
read_jrc_csv(jrc_csv, cell_mode, trim_negat, trim_noise): Import spike timing data form JRClust output.
...
def read_jrc_csv(jrc_csv, cell_mode=True, trim_negat=True, trim_noise=False):
    """ Import spike timing data form JRClust output.

     Args:
          jrc_csv (str): Cell spike timing CSV file generated by [JRClust].
    ...
    """
    with open(jrc_csv, "r") as csv_file:
