...
from parus.train.dataset import NoLabelSingleFileDataset
...
if __name__ == '__main__':
    ...
    for filename in filename_lst:
        ...
        inf_dataset = NoLabelSingleFileDataset(file_path, model_hparams["sequence_length"])
        ...
        inference(model, inf_datagen, filename, inf_pred_folder)
