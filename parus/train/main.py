...
if __name__ == '__main__':
    ...
    setup_experiment(model_hparams["model_name"],
                     train_hparams["experiment_folder"])
    ...
    # get datagen
    trn_folder = os.join(data_hparams["data_folder"], "trn")
    trn_datagen = get_lbl_datagen(os.join(trn_folder, "sig"), os.join(
        trn_folder, "lbl"), model_hparams["sequence_length"], data_hparams, "trn")
    val_folder = os.join(data_hparams["data_folder"], "val")
    val_datagen = get_lbl_datagen(os.join(val_folder, "sig"), os.join(
        val_folder, "lbl"), model_hparams["sequence_length"], data_hparams, "val")
    tst_folder = os.join(data_hparams["data_folder"], "tst")
    tst_datagen = get_lbl_datagen(os.join(tst_folder, "sig"), os.join(
    ...
    train(model, criterion, optimizer, scheduler,
          trn_datagen, val_datagen, train_hparams)
